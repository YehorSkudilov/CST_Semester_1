...
public class NameDriver {
    ...
    /**
     * main. Drive the program.
     * @param args unused.
     */
    public static void main(String[] args) {
        Scanner scan = new Scanner(System.in);
        System.out.println("Type a first middle and last name seperated by "
                + "space (example: John Alex Dough):");
        Name name = new Name(scan.next(), scan.next(), scan.next());
        System.out.println(name.getLength());
        System.out.println(name.getInitials());
        System.out.println("Which character would you like to see? "
                + "Type number: ");
