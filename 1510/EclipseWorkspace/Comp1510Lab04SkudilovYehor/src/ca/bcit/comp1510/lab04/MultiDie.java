 ...
 *  It would be confusing if the same die object could transform from 6 sides to 10. 
 *  
 * 4. What does max’s being final say about the abstraction of a MultiDie object? 
 * Having max final enforces the abstraction that a MultiDie object represents a die with a fixed number of sides,
 ...
 * In a Java record, all fields are final and cannot be changed after the object is created but a die needs to change 
